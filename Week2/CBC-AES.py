...
if __name__ == '__main__':
    key = '140b41b22a29beb4061bda66b6747e14'  #定义key值
    ...
    to_encrypt = '123456'
    to_decrypt = '5b68629feb8606f9a6667670b75b38a5'+ aes.encrypt(to_encrypt)  #前缀是IV

    print("\n加密前:{0}\n加密后：{1}\n".format(to_encrypt,aes.encrypt(to_encrypt)))
    print("解密前:{0}\n解密后：{1}\n".format(to_decrypt,aes.decrypt(to_decrypt)))
    ...
    print("解密前:{0}\n解密后：{1}\n".format(CypherText_Hex,aes.decrypt(CypherText_Hex)))
    ...
    #print(aes.IV)
    print("解密前:{0}\n解密后：{1}\n".format(CypherText_Hex2,aes.decrypt(CypherText_Hex2)))